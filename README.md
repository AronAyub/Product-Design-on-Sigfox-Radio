...
For the devices and sensors to communicate, Sigfox do not use WiFi, GSM that depends on Sim cards but uses special chipsets called **Sigfox Radio Modules** 
